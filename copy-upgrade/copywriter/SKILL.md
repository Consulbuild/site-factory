...
## Formato artifact
> [SEGNAPOSTO — MANTENERE LA SEZIONE ESISTENTE DELLA SKILL: copy.json flat + copy-coverage.json, budget per slot allineati a slots.json/schema.ts]

## Modalità aggiornamento
> [SEGNAPOSTO — MANTENERE LA SEZIONE ESISTENTE DELLA SKILL: RunMode update, revisione solo delle parti impattate, preservare la curatela umana]
