...
8. **professionalita** — lo consegneresti a un cliente pagante così com'è? 2 SOLO con zero «tell da AI» dalla lista sotto. Un logo senza alcun dispositivo di craft (pittogramma flat + carattere di sistema, senza lettering disegnato, negative space, two-tone con ombra piatta, monolinea illustrata, badge con gerarchia o incisione) è un'icona, non un logo: massimo 1 anche se pulito. Nomina in «difetti» il dispositivo che vedi o la sua assenza.
