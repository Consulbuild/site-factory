...
export const INFORMATIVA_SINTESI =
  "Usiamo i tuoi dati solo per preparare il tuo nuovo sito e per contattarti. Titolare: ConsulBuild di Vecchiato Edoardo. Se non attivi il servizio, cancelliamo tutto entro 60 giorni.";
...
<ul>
  <li><strong>Finalità:</strong> preparare la versione dimostrativa del tuo nuovo sito web con i dati, le foto e il logo che ci fornisci, e ricontattarti per mostrartela (dare riscontro alla tua richiesta).</li>
  <li><strong>Base giuridica:</strong> esecuzione di misure precontrattuali adottate su tua richiesta (art. 6, par. 1, lett. b, GDPR).</li>
  ...
  <li><strong>Conservazione:</strong> se non attivi il servizio, i dati e le foto vengono cancellati entro 60 giorni dall'invio; se lo attivi, per tutta la durata del rapporto e per i termini di legge successivi.</li>
