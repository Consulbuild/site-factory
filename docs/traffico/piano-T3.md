...
| 3 | Comuni serviti precisi | parziale: sede (v4 con sigla; Tally solo nome) e comuni «Nome (SIGLA)» nelle zone | area servita della scheda: **solo** Business Profile API da Gestore (quota 0 oggi, R1 §8.1); Places e DataForSEO My Business Info non la restituiscono | **sempre, precompilata** · chip selezionati: sede e comuni precisi del lead («Ci avevi indicato»); chip non selezionati: i comuni più vicini alla sede (T6a, linea d'aria) |
