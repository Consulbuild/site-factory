...
| T6a | Fatti comunali | `comuni-fatti.json` con fonte/licenza, offline in build | fatto (2026-09-14), collaudato e chiuso (piano § Verifica) con **dataset dichiarato incompleto**: anagrafica e centri 2026, alias, popolazione 2025, sismica e zona climatica presenti; edifici 2011 e famiglie 2021 in attesa di `esploradati.istat.it` (aperti: M0 e scelta del file per sezioni per gli edifici) | `14f2fe3`, `8561389`, `1f66586`, `c22a76e`, `866e6f6`, `4997dad` + chiusura documenti |
